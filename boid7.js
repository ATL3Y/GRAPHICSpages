var Boid = function(scene, octree, obstacles, velocity_hash, position, orientation) {
    this.scene = scene;
    this.octree = octree;
...
Boid.prototype.init_mesh = function(position, orientation) {
...
Boid.prototype.apply_limit = function(vector, min, max) {
...
Boid.prototype.update_forces = function() {
    var v1, v2, v3;
...
Boid.prototype.get_random_color = function () {
...
Boid.prototype.update_position = function(elapsed_time, lookAt) {
